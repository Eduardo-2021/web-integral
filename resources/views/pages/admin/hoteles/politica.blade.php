...
<div class="col-md-10" style="margin-left: 8%">
  <h1 class="tpolitica">Politica de privacidad</h1>

  <p class="ppolitica">La presente Política de Privacidad establece los términos en que RealEngineers 
  usa y protege la información que es proporcionada por sus usuarios al momento de utilizar su sitio 
  web. Esta compañía está comprometida con la seguridad de los datos de sus usuarios. Cuando le pedimos 
  ...
  <h1 class="tpolitica">Información que es recogida</h1>

  <p class="ppolitica">Nuestro sitio web podrá recoger información personal, por ejemplo: Nombre, información de 
  ...
  <h1 class="tpolitica">Uso de la información recogida</h1>

  <p class="ppolitica">Nuestro sitio web emplea la información con el fin de proporcionar el mejor servicio posible, 
  ...
  RealEngineers está altamente comprometido para cumplir con el compromiso de mantener su información 
  ...
  <h1 class="tpolitica">Cookies</h1>

  <p class="ppolitica">Una cookie se refiere a un fichero que es enviado con la finalidad de solicitar permiso para 
  ...
  individualmente y por tanto brindarte el mejor servicio personalizado de su web.<br>
  ...
  quiera y la proporcione directamente noticias. Usted puede aceptar o negar el uso de cookies, sin 
  embargo, la mayoría de navegadores aceptan cookies automáticamente pues sirve para tener un mejor 
  ...
  <h1 class="tpolitica">Enlaces a Terceros</h1>

  <p class="ppolitica">Este sitio web pudiera contener en laces a otros sitios que pudieran ser de su interés. Una 
  ...
  usted está de acuerdo con estas.</p><br>

  <h1 class="tpolitica">Control de su información personal</h1>

  <p class="ppolitica">En cualquier momento usted puede restringir la recopilación o el uso de la información personal 
  que es proporcionada a nuestro sitio web.  Cada vez que se le solicite rellenar un formulario, como 
  el de alta de usuario, puede marcar o desmarcar la opción de recibir información por correo electrónico.  
  En caso de que haya marcado la opción de recibir nuestro boletín o publicidad usted puede cancelarla en 
  cualquier momento.
  ...
  RealEngineers Se reserva el derecho de cambiar los términos de la presente Política de Privacidad en 
  cualquier momento.
  </p><br>
</div>
@endsection